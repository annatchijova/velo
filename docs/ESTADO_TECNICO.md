...
es la misma escalera epistémica que usan las cuatro rondas de red team del
...
### 3.7 Auditoría adversarial de nuestro propio sistema: cuatro rondas
...
**Totales de las cuatro rondas: 28 entradas / 27 hallazgos. 21 arreglados, 1
...
y el sistema fue atacado cuatro veces por sus propios autores con 27 hallazgos
escritos y 21 arreglados. Miren lo que registramos como roto: esa es la parte
