...
Expected: `Tests  116 passed (116)`. **277 across both**, which is the number to
quote: 161 engine + 116 frontend. Quoting only the root suite makes the frontend
...
Esperado: `Tests  116 passed (116)`. **277 entre las dos**, que es el número a
citar: 161 del motor + 116 del frontend. Citar solo la suite raíz hace parecer
