...
Expected: `Tests  116 passed (116)`. **286 across both**, which is the number to
quote: 170 engine + 116 frontend. Quoting only the root suite makes the frontend
...
Esperado: `Tests  116 passed (116)`. **286 entre las dos**, que es el número a
citar: 170 del motor + 116 del frontend. Citar solo la suite raíz hace parecer
