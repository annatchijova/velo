...
### 3.7 Adversarial audit of our own system: four rounds
...
**Totals across the four rounds: 28 entries / 27 findings. 21 fixed, 1
...
system has been attacked four times by its own authors with 27 findings written
down and 21 fixed. Look at what we recorded as broken — that is the part that
